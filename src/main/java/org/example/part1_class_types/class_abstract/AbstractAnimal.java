...
/*
    Ce este?
       O clasa abstracta este o clasa care nu poate sa instantieze un obiect, in plus poate sau nu sa contina
       metode abstracte.
    ...
    Cand folosim?
        ...
        generice metite a fi implementate in mod specific in clasele copil.
    ...
    Scenarii comune:
        - o clasa abstracta poate fi o clasa parinte pt o serie de tabele care stocheaza o cheie primara si
        strategia de indexare in baza de date relationala.
